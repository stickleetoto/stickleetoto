...
**Building systems and developer tools for AI agents.**

I focus on small, practical infrastructure that gives LLM agents better ways to **compute, search, and ship software**.
...
`AI Agents` · `MCP` · `Systems` · `Developer Tools` · `Local AI`

---

> Build the capability behind the interface, not the complexity in front of it.
